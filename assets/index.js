            ...
            juegos: [
                {
                    ...
                    descripcion:
                        "En Catan, los jugadores intentan ser la fuerza dominante en la isla de Catan mediante la construcción de asentamientos, ciudades y carreteras. En cada turno se tiran los dados para determinar qué recursos produce la isla.",
                    precioNormal: "$34.990",
                    precioOferta: "",
                ...
                },
                {
                    ...
                    descripcion:
                        "¡Bienvenidos a San Francisco! Puedes sentir el peso de los souvenirs en la mochila mientras te asomas desde el tranvía.",
                    precioNormal: "$25.990",
                    precioOferta: "$19.990",
                ...
                },
                {
                    ...
                    titulo: "Pendulum",
                    descripcion:
                        "Los jugadores deben usar el tiempo real como un recurso y afinar la estrategia para superar a sus oponentes. Fue el prototipo mejor calificado en la historia del del Diseño de Stonemaier Games.",
                    precioNormal: "$59.990",
                    precioOferta: "$50.992",
            ...
            juegos: [
                {
                    ...
                    descripcion:
                        "Este juego de cartas requiere de toda tu atención y rapidez. ¡Sobre todo rapidez! La vas a necesitar para no quedarte con todas las cartas del centro de la mesa.",
                    precioNormal: "$11.990",
                    precioOferta: "",
                ...
                },
                {
                    ...
                    descripcion:
                        "Dixit Expansión: Harmonies (Dixit 8) es la octava expansión para el juego Dixit, incorpora el arte único y poderoso de Paul Echegoye, contiene 84 nuevas cartas para que pongan a volar la imaginación.",
                    precioNormal: "$25.000",
                    precioOferta: "$19.990",
                ...
                },
                {
                    ...
                    titulo: "¡Hula-Hula!",
                    descripcion:
                        "¡El gran mundial de Hula Hula ha comenzado! Animales de todo el mundo se han congregado para demostrar sus dotes.",
                    precioNormal: "$20.000",
                    precioOferta: "$12.990",
            ...
            juegos: [
                {
                    ...
                    descripcion:
                        "EXIT Kids: Acertijos en la jungla es un juego de escape cooperativo, que se puede disfrutar en solitario o en un grupo de hasta 4 personas, a partir de 5 años, en partidas que pueden durar unos 20 minutos.",
                    precioNormal: "$14.990",
                    precioOferta: "",
                ...
                },
                {
                    ...
                    descripcion:
                        "El hechicero te ha enviado, un pilluelo de la calle como Aladdin, a una cueva para buscar una lámpara mágica que te permita invocar los favores de un genio.",
                    precioNormal: "$30.000",
                    precioOferta: "$24.990",
                ...
                },
                {
                    ...
                    descripcion:
                        "Salvar el mundo se ha vuelto un poco más difícil en Pandemic: Estado de Emergencia, una expansión para Pandemic.",
                    precioNormal: "$39.990",
                    precioOferta: "$33.992",
            ...
            juegos: [
                {
                    ...
                    descripcion:
                        "Master of Orion: El Juego de Mesa te lleva al mundo del legendario videojuego de estrategia. Vas a dirigir a una de las razas que se enfrentarán en la confrontación con el espacio exterior.",
                    precioNormal: "$19.990",
                    precioOferta: "",
                ...
                },
                {
                    ...
                    descripcion:
                        "¡Participa en una de las historias de ciencia ficción más famosas de todos los tiempos! Control de una de las cuatro grandes facciones: la Casa Atreides, la Casa Harkonnen, los Fremen y el Imperio.",
                    precioNormal: "$59.990",
                    precioOferta: "$47.992",
                ...
                },
                {
                    ...
                    descripcion:
                        "¡Conviértete en Rambo y toma el control de la historia de la película First Blood! Revive la acción y llénate de nostalgia en este juego de mesa en solitario.",
                    precioNormal: "$49.990",
                    precioOferta: "$39.992",
...
const registroUsuarioLimpiarForm = () => {
    console.log("limpiar");
    ...
    document.querySelector("#repetirContrasena").value = "";
    document.querySelector("#fechaNacimiento").value = "";
    document.querySelector("#direccionDespacho").value = "";
};
const registroUsuarioValidar = () => {
    ...
    const correoElectronico = document.querySelector("#correoElectronico").value.trim();
    const contrasena = document.querySelector("#contrasena").value.trim();
    const repetirContrasena = document.querySelector("#repetirContrasena").value.trim();
    const fechaNacimiento = document.querySelector("#fechaNacimiento").value.trim();
    const direccionDespacho = document.querySelector("#direccionDespacho").value.trim();

    // Validar que ningún campo del formulario esté vacío excepto dirección de despacho
    if (
        nombreCompleto === "" ||
        nombreUsuario === "" ||
        correoElectronico === "" ||
    ...
    // Validar que la contraseña contenga al menos un número y una mayúscula
